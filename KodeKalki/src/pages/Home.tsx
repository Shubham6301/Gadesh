        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/Shubham6301" className="p-3 bg-gray-800 rounded-xl text-gray-400 hover:text-gray-300 transition-all duration-300 hover:scale-110 hover:bg-gray-700">
                  <Github className="h-6 w-6" />
                </a>
                <a href="https://mail.google.com/" className="p-3 bg-gray-800 rounded-xl text-gray-400 hover:text-blue-400 transition-all duration-300 hover:scale-110 hover:bg-gray-700">
                  <GoMail className="h-6 w-6" />
                </a>
                <a href="https://www.linkedin.com/in/shubham-saxena-303183286/" className="p-3 bg-gray-800 rounded-xl text-gray-400 hover:text-blue-500 transition-all duration-300 hover:scale-110 hover:bg-gray-700">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <Link to="/problems" className="text-gray-300 hover:text-white transition-colors duration-300 inline-block">Problems</Link>
                </li>
                <li>
                  <Link to="/contest" className="text-gray-300 hover:text-white transition-colors duration-300 inline-block">Contests</Link>
                </li>
                <li>
                  <Link to="/game" className="text-gray-300 hover:text-white transition-colors duration-300 inline-block">Game Mode</Link>
                </li>
                <li>
                  <Link to="/top" className="text-gray-300 hover:text-white transition-colors duration-300 inline-block">Discussions</Link>
                </li>
                <li>
                  <Link to="/interview" className="text-gray-300 hover:text-white transition-colors duration-300 inline-block">Interview Practice</Link>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center text-gray-300 group">
                  ...
                  <span className="group-hover:text-white transition-colors duration-300">shubhamsaxena6301@gmail.com</span>
                </li>
                <li className="flex items-center text-gray-300 group">
                  <div className="p-2 bg-gray-800 rounded-lg mr-3 group-hover:bg-gray-700 transition-colors duration-300">
                    <Phone className="h-5 w-5" />
                  </div>
                  <span className="group-hover:text-white transition-colors duration-300">+91 6306336927</span>
                </li>
                <li className="flex items-center text-gray-300 group">
                  <div className="p-2 bg-gray-800 rounded-lg mr-3 group-hover:bg-gray-700 transition-colors duration-300">
                    <MapPin className="h-5 w-5" />
                  </div>
                  <span className="group-hover:text-white transition-colors duration-300">Uttar Pradesh, India</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2026 KodeKalki. All rights reserved. Built with ❤️ for developers.
            </p>
            <div className="flex space-x-8 mt-4 md:mt-0">
              <Link to="/privacy-policy" className="text-gray-400 hover:text-white text-sm transition-colors duration-300 hover:underline">
                Privacy Policy
              </Link>
              <Link to="/terms-of-service" className="text-gray-400 hover:text-white text-sm transition-colors duration-300 hover:underline">
                Terms of Service
              </Link>
              <Link to="/cookie-policy" className="text-gray-400 hover:text-white text-sm transition-colors duration-300 hover:underline">
                Cookie Policy
              </Link>
            </div>
          </div>
